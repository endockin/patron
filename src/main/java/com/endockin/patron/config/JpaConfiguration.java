...
@Configuration
@EnableJpaRepositories("com.endockin.patron.repository")
...
public class JpaConfiguration {
  ...
  private static final String PROPERTY_NAME_HIBERNATE_CACHE_REGION = "hibernate.cache.region.factory_class";
  private static final String PROPERTY_NAME_HIBERNATE_USE_L2_CACHE = "hibernate.cache.use_second_level_cache";
  ...
  public DataSource dataSource() {
    ...
    dataSource.setPassword(env.getRequiredProperty(PROPERTY_NAME_DATABASE_PWD));
  ...
  private Properties hibProperties() {
    ...
    properties.put(PROPERTY_NAME_HIBERNATE_GENERATE_STATISTICS,
    ...
    properties.put(PROPERTY_NAME_HIBERNATE_USE_L2_CACHE,
        env.getRequiredProperty(PROPERTY_NAME_HIBERNATE_USE_L2_CACHE));
    properties.put(PROPERTY_NAME_HIBERNATE_CACHE_REGION,
        env.getRequiredProperty(PROPERTY_NAME_HIBERNATE_CACHE_REGION));
